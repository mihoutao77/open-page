...
if st.button("🎨🕊️ Generate a random color scheme 🎲"):
...
if st.checkbox("Apply theme to this page🕊️"):
...
## how to use UI
First,Click box🍇（Apply theme to this page🕊️）\n 
Then click the button (🎨🕊️Generate a random color scheme 🎲)
